...
public class Project77
{
	...
	public static void main(String[] args) throws FileNotFoundException
	{
		...
		while (continuePlaying.equalsIgnoreCase("yes"))
		{
			...
			String scrambledWord = scrambledWordGenerator(word);
			int numGuesses = returnNumGuesses(word, scrambledWord);
			int pointsEarned = word.length() - numGuesses;
			
			//returnNumGuesses(word, scrambledWord);
			resultPrint (word, pointsEarned, wordPoints);
	...
	public static String chooseRandomWord() throws FileNotFoundException {
		// Construct a Scanner and connect it to the text file that //METHOD1
					// contains the words.
					Scanner dictionary = new Scanner(new File("C:/Eclipse_Farz/Project7/src/dictionary.txt"));
					...
					dictionary.close(); //ENDS 1
					
					return word;
	}
	
	public static String scrambledWordGenerator (String word) {
		// Construct StringBuilder objects used to scramble the word. The //METHOD 2 
					...
					String scrambledWord = scrambledTempWord.toString(); //ENDS 2
					
					return scrambledWord;
	}
	
	public static int returnNumGuesses (String word, String scrambledWord)  {
		// Let the user guess the word. The number of allowed guesses is //METHOD 3
	...
	public static void resultPrint (String word, int pointsEarned, int wordPoints) {
		// If the user earned 0 points, show them the correct word. //METHOD 4
