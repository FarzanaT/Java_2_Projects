...
public class tryyy {
	...
	public static void main(String []args){
	    ...
	    public static String decodeString(String s) {
	        /*
	        make a stack 
	        keep pushing each char of the s
	        until ']' is found
	        when ']' found -> a closed bracket element is finished 
	        hence, store in a stringBuilder -> string
	        find the previous digit beofore '[' 
	        repeat the string to that many times of the digit in the string
	        add the final string to the stack 
	        keep doing until -> it has traversing the end of the string
